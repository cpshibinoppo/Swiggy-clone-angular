...
export declare class BsCustomDatesViewComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<BsCustomDatesViewComponent, "bs-custom-date-view", never, { "ranges": "ranges"; "selectedRange": "selectedRange"; "customRangeLabel": "customRangeLabel"; }, { "onSelect": "onSelect"; }, never, never, false>;
}
